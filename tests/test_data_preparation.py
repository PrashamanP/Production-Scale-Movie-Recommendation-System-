...
def test_load_and_prepare_data_output_structure(synthetic_interactions_csv):
    ...
    matrix, user_map, movie_map = _load_and_prepare_data(synthetic_interactions_csv)
...
def test_load_and_prepare_data_map_content(synthetic_interactions_csv):
    ...
    _, user_map, movie_map = _load_and_prepare_data(synthetic_interactions_csv)
...
def test_load_and_prepare_data_empty_csv(tmp_path):
    ...
    matrix, user_map, movie_map = _load_and_prepare_data(str(file_path))
...
def test_load_and_prepare_data_with_na_handles_content(tmp_path):
    ...
    _, user_map, _ = _load_and_prepare_data(str(file_path))
...
def test_load_and_prepare_data_missing_file(tmp_path):
    ...
    matrix, user_map, movie_map = _load_and_prepare_data(str(non_existent_file))
